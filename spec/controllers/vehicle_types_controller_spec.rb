...
describe VehicleTypesController do
  ...
  describe "GET index" do
    it "assigns all vehicle_types as @vehicle_types" do
      ...
      assigns(:vehicle_types).should eq([vehicle_type])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested vehicle_type as @vehicle_type" do
      ...
      assigns(:vehicle_type).should eq(vehicle_type)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new vehicle_type as @vehicle_type" do
      ...
      assigns(:vehicle_type).should be_a_new(VehicleType)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created vehicle_type as @vehicle_type" do
        post :create, {:vehicle_type => valid_attributes}, valid_session
        assigns(:vehicle_type).should be_a(VehicleType)
        assigns(:vehicle_type).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved vehicle_type as @vehicle_type" do
        ...
        post :create, {:vehicle_type => { "name" => "invalid value" }}, valid_session
        assigns(:vehicle_type).should be_a_new(VehicleType)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested vehicle_type" do
        vehicle_type = VehicleType.create! valid_attributes
        # Assuming there are no other vehicle_types in the database, this
        # specifies that the VehicleType created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        VehicleType.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => vehicle_type.to_param, :vehicle_type => { "name" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the vehicle_type" do
        vehicle_type = VehicleType.create! valid_attributes
        put :update, {:id => vehicle_type.to_param, :vehicle_type => valid_attributes}, valid_session
        response.should redirect_to(vehicle_type)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the vehicle_type as @vehicle_type" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        VehicleType.any_instance.stub(:save).and_return(false)
        put :update, {:id => vehicle_type.to_param, :vehicle_type => { "name" => "invalid value" }}, valid_session
        assigns(:vehicle_type).should eq(vehicle_type)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the vehicle_types list" do
      vehicle_type = VehicleType.create! valid_attributes
      delete :destroy, {:id => vehicle_type.to_param}, valid_session
      response.should redirect_to(vehicle_types_url)
    end
  end
