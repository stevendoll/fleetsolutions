class EquipmentTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @equipment_type.save
        ...
        format.json { render action: 'show', status: :created, location: @equipment_type }
      else
  ...
  private
    ...
    def equipment_type_params
      params.require(:equipment_type).permit(:name, :fuel_per_hour, :conversion_cost, :propane_factor, :display_order)
    end
end
