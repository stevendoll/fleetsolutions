class VehicleTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @vehicle_type.save
        ...
        format.json { render action: 'show', status: :created, location: @vehicle_type }
      else
  ...
  private
    ...
    def vehicle_type_params
      params.require(:vehicle_type).permit(:name, :year, :miles, :lifetime_miles, :mileage, :miles_per_year, :resale_value, :conversion_cost, :propane_factor, :display_order)
    end
end
