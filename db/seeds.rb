...
puts 'POSTS'
post = Post.find_or_create_by_title(:title => 'Excitement at LPG show and tell in Maryland', :teaser => 'There was some excitement for the steady growth in LPG fleet projects at the MAGPA event in Maryland.', :body => 'There was some excitement for the steady growth in LPG fleet projects at the MAGPA event in Maryland. ') 
